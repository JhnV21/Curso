...
dinheiro_cheque = valor_produto - valor_produto * 0.1
debito = valor_produto - valor_produto * 0.05
parcelado = valor_produto
...
if pagamento == 1:
    ...
    print(f'Voce não ganha desconto, valor original R${parcelado:.2f}')
elif pagamento == 4:
